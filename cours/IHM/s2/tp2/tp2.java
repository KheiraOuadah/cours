...
public class tp2 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        addWidgetsToSceneV1(this.conteneur);
    ...
    private void addListeners(){
        ControlButton controbtn = new ControlButton(this);
        this.moyenne.setOnAction(controbtn);
    ...
    public void addWidgetsToSceneV1(FlowPane conteneur) {
        ...
        vbox.getChildren().addAll(this.menuBar, flow1,flow2,flow3,flow4,flow5,this.cb,flow6);

//        conteneur = new FlowPane();
        conteneur.setVgap(4);
        conteneur.setHgap(4);
    ...
    public String getAnglais() {
        return this.AnglaisTextField.getText();
    }

    public String getMathematiques() {
        return this.mathsTextField.getText();
    }

    public String getInformatique() {
        return this.infoTextField.getText();
    }

    public String getGeographie() {
        return this.geoTextField.getText();
    }

    public String getOption() {
        return this.optionnelTextField.getText();
    }
